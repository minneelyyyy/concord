                       ...
                       struct discord_ret_channel *ret)
{
    ...
    CCORD_EXPECT(
        client,
        discord_modify_channel_to_json(&body.start, &body.size, params)
            == JSONB_OK,
                       ...
                       struct discord_ret_message *ret)
{
    ...
    CCORD_EXPECT(
        client,
        discord_create_message_to_json(&body.start, &body.size, params)
            == JSONB_OK,
        CCORD_MALFORMED_PAYLOAD, "Failed to encode JSON");
    DISCORD_ATTR_INIT(attr, discord_message, ret, NULL);
                     ...
                     struct discord_ret_message *ret)
{
    ...
    CCORD_EXPECT(client, params != NULL, CCORD_BAD_PARAMETER, "");
    CCORD_EXPECT(client,
                 discord_edit_message_to_json(&body.start, &body.size, params)
                     == JSONB_OK,
                 CCORD_MALFORMED_PAYLOAD, "Failed to encode JSON");
    DISCORD_ATTR_INIT(attr, discord_message, ret, NULL);
    return discord_rest_run(&client->rest, &attr, &body, HTTP_PATCH,
                             ...
                             struct discord_ret *ret)
{
    ...
    CCORD_EXPECT(
        client,
        discord_bulk_delete_messages_to_json(&body.start, &body.size, params)
            == JSONB_OK,
        CCORD_MALFORMED_PAYLOAD, "Failed to encode JSON");
    ...
    struct discord_ret *ret)
{
    ...
    CCORD_EXPECT(client, params != NULL, CCORD_BAD_PARAMETER, "");
    CCORD_EXPECT(client,
                 discord_edit_channel_permissions_to_json(&body.start,
                                                          &body.size, params)
                     == JSONB_OK,
                 CCORD_MALFORMED_PAYLOAD, "Failed to encode JSON");
    DISCORD_ATTR_BLANK_INIT(attr, ret, params->reason);
                              ...
                              struct discord_ret_invite *ret)
{
    ...
    CCORD_EXPECT(
        client,
        discord_create_channel_invite_to_json(&body.start, &body.size, params)
            == JSONB_OK,
        CCORD_MALFORMED_PAYLOAD, "Failed to encode JSON");
                            ...
                            struct discord_ret_followed_channel *ret)
{
    ...
    CCORD_EXPECT(
        client,
        discord_follow_news_channel_to_json(&body.start, &body.size, params)
            == JSONB_OK,
        CCORD_MALFORMED_PAYLOAD, "Failed to encode JSON");
    DISCORD_ATTR_INIT(attr, discord_channel, ret, NULL);
    return discord_rest_run(&client->rest, &attr, &body, HTTP_POST,
                               ...
                               struct discord_ret *ret)
{
    ...
    CCORD_EXPECT(
        client,
        discord_group_dm_add_recipient_to_json(&body.start, &body.size, params)
            == JSONB_OK,
        CCORD_MALFORMED_PAYLOAD, "Failed to encode JSON");
    DISCORD_ATTR_BLANK_INIT(attr, ret, NULL);
    return discord_rest_run(&client->rest, &attr, &body, HTTP_PUT,
    ...
    struct discord_ret_channel *ret)
{
    ...
    CCORD_EXPECT(client, params != NULL, CCORD_BAD_PARAMETER, "");
    CCORD_EXPECT(client,
                 discord_start_thread_with_message_to_json(&body.start,
                                                           &body.size, params)
                     == JSONB_OK,
                 CCORD_MALFORMED_PAYLOAD, "Failed to encode JSON");
    DISCORD_ATTR_INIT(attr, discord_channel, ret, params->reason);
